...
File.open(File.join(File.dirname(__FILE__), "images/jpc_icon.png"), "rb") { |new_icon_file|
...
class Installation < Shoes
  ...
  @@installer_content_two_colomn_style = {:width => 450, :height => 450}
  @@installer_content_1_3_colomn_style = {:width => 300, :height => 450}
  @@installer_content_2_3_colomn_style = {:width => 650, :height => 450}
  ...
  ##
  # This method creates a bunch of kinds of buttons (back, next, back_text, next_text, finish, cancel)
  ...
  # for cancle button, the button created are Link and should be put into a container
  # whose size is equal or larger than 100x50
  # *type* :: <tt>:back</tt>, <tt>:next</tt>, <tt>:back_text</tt>, <tt>:next_text</tt>, <tt>finish</tt> or <tt>cancel</tt>
