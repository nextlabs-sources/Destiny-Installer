    ...
    stack @@installer_page_size_style do
      ...
      stack @@installer_content_size_style do
        ...
        stack :width => 1.0, :height => 40 do
          para ReadableNames["ready_to_install_page"][$item.installation_mode]["heading"], @@heading_1_style
        end

        stack :width => 1.0, :height => 60 do
          para ReadableNames["ready_to_install_page"][$item.installation_mode]["help_note"], @@help_note_style
        end

        stack :width => 1.0, :height => 40 do
          para ReadableNames["ready_to_install_page"][$item.installation_mode]["help_note_2"], @@help_note_style
        end

        stack :width => 1.0, :height => 40 do
          para ReadableNames["ready_to_install_page"][$item.installation_mode]["help_note_3"], @@help_note_style
        end
